...
lemma H_values: (* This should go in Quantum.thy *)
  fixes i j:: nat
...
(* Tidied up version where the measurement of n qubits in a n+1 qubit system is stated as a definition. 
...
definition prob0_fst_qubits:: "nat \<Rightarrow> complex Matrix.mat \<Rightarrow> real" where (* To move in Measurement.thy *)
...
primrec iter_post_meas0:: "nat \<Rightarrow> nat \<Rightarrow> complex Matrix.mat \<Rightarrow> complex Matrix.mat" where (* To move in Quantum.thy or better in a new file Measurement.thy *)
...
definition iter_prob0:: "nat \<Rightarrow> nat \<Rightarrow> complex Matrix.mat \<Rightarrow> real" where (* idem *)
